...
description (promotional text) for language pl-PL"*, measured by a validate-only promotion of an
app built from this template. A missing file leaves that field as Play already has it.
